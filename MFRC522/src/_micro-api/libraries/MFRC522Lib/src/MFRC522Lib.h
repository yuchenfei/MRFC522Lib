...
public:
	...
	enum StatusCode {
		...
		STATUS_NO_TAG		= 4,	// 未发现标签
		STATUS_NO_ROOM		= 5,	// 缓冲区空间不足
		STATUS_COLLISION	= 6		// 发生碰撞
	};
	...
	//标签操作函数
	////////////////////////////////////////////////////////////////////////////////////////////////////
	MFRC522::StatusCode PICC_Request(byte reqCommand, byte *bufferATQA);
	MFRC522::StatusCode PICC_Anticollision(byte *bufferUID);
